...
export const state = () => ({
    ...
    metaProducts: [], // information about goods received from api (name, price, pictures, etc.)
    version: '0.0.1' // this state parameter is used to resolve the conflict of versions of the current storage for the user and our site
})
